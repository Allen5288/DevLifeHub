...
import { TextField, Button, Typography, Paper, IconButton, InputAdornment, Alert, MenuItem } from '@mui/material'
import {
  Visibility,
  VisibilityOff,
...
const validationSchema = Yup.object({
  ...
  securityAnswer: Yup.string().required('Please provide an answer').min(2, 'Answer must be at least 2 characters'),
})
